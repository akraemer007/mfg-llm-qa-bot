...
# MAGIC %md TODO update wait_for_index_to_be_ready in 00-init. It seems that it is indexing incorrectly (in ['index_status']['index_state']) 

# COMMAND ----------

#Let's wait for the index to be ready and all our embeddings to be created and indexed
# wait_for_index_to_be_ready(vs_index_fullname) # TODO FIX THIS
